...
void showGames() {
  if (managerPhase==mP.GameStart) {
    ...
    if (gameOptions.get("Player1")==0) {
      ...
      game.participants[1] = new player(1, "uct-1", brain.UCBUCT);
    } else {
    ...
    if (gameOptions.get("Player2")==0) {
      ...
      game.participants[2] = new player(2, "uct-2", brain.UCBUCT);
    } else {
    ...
    if (gameOptions.get("Player3")==0) {
      ...
      game.participants[3] = new player(3, "uct-3", brain.UCBUCT);
    } else {
    ...
    if (gameOptions.get("Player4")==0) {
      ...
      game.participants[4] = new player(4, "uct-4", brain.UCBUCT);
    } else {
