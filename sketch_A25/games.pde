...
void showGames() {
  if (managerPhase==mP.GameStart) {
    ...
    if (gameOptions.get("Player2")==0) {
      ...
      game.participants[2] = new player(2, "ucb-mc2", brain.UCBFast);
    ...
    if (gameOptions.get("Player3")==0) {
      ...
      game.participants[3] = new player(3, "uct-mc3", brain.UCBFast);
    ...
    if (gameOptions.get("Player4")==0) {
      ...
      game.participants[4] = new player(4, "uct-mc4", brain.UCBFast);
