...
class board {
  ...
  void ucbMcSimulatorRegularDisplay() {// display(11)
    textAlign(CENTER, CENTER);
    background(255);
    for (int i = 0; i < 25; i ++) {
      s[i].sv=sv[i];
  ...
  void ucbMcSimulatorAttackchanceDisplay() {// display(11)
    textAlign(CENTER, CENTER);
    background(255);
    for (int i = 0; i < 25; i ++) {
      s[i].sv=sv[i];
  ...
  void uctMctsSimulatorDisplay(){ // former: display(12);
    textAlign(CENTER, CENTER);
    background(255);
    for (int i = 0; i < 25; i ++) {
      s[i].sv=sv[i];
