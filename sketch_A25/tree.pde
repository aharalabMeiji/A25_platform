...
class treeNode {
  ...
  void showTreeNode(float x, float y, float wid) {
    ...
    if (thisNode.childR==null) stroke(255);
    else stroke(0);
    noFill();
...
class gameTree {
  ...
  void setButtons() {
    buttonTree11.setLTWH(utils.unitSize*0.09, utils.mainU+utils.unitSize*0.055, utils.unitSize*0.25, utils.unitSize*0.275);
    buttonTree13.setLTWH(utils.unitSize*0.66, utils.mainU+utils.unitSize*0.055, utils.unitSize*0.25, utils.unitSize*0.275);
    ...
    buttonTree21.setLTWH(utils.unitSize*0.09, utils.mainU+utils.unitSize*0.425, utils.unitSize*0.25, utils.unitSize*0.275);
    buttonTree23.setLTWH(utils.unitSize*0.66, utils.mainU+utils.unitSize*0.425, utils.unitSize*0.25, utils.unitSize*0.275);
  }
  void show() {
    background(255);
    textAlign(LEFT, TOP);
    treeNode11.showTreeNode(utils.unitSize*0.09, utils.mainU+utils.unitSize*0.055, utils.unitSize*0.25);
    treeNode12.showTreeNode(utils.unitSize*0.35, utils.mainU, utils.unitSize*0.3);
    treeNode13.showTreeNode(utils.unitSize*0.66, utils.mainU+utils.unitSize*0.055, utils.unitSize*0.25);
    stroke(0);
    fill(utils.playerColor[color2]);
    ...
    textAlign(LEFT, TOP);
    treeNode21.showTreeNode(utils.unitSize*0.09, utils.mainU+utils.unitSize*0.425, utils.unitSize*0.25);
    treeNode22.showTreeNode(utils.unitSize*0.35, utils.mainU+utils.unitSize*0.425, utils.unitSize*0.3);
    treeNode23.showTreeNode(utils.unitSize*0.66, utils.mainU+utils.unitSize*0.425, utils.unitSize*0.25);
  ...
  void mousePressedTree() {
    if (buttonTree11.mouseOn()) {
      ...
      setAllPanes();
    } else if (buttonReturnToMenu.mouseOn()) {
      displayManager = dP.onContents;
      managerPhase=mP.GameStart;
      return;
    } else if (buttonSaveScreenShot.mouseOn()){
      frameRate(1);
